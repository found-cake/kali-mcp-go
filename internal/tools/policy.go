...
func profileLimits(profile dto.SafetyProfile) dto.ScanOptions {
	...
	case dto.ProfileSafeRecon:
		return dto.ScanOptions{RateLimit: 10, Concurrency: 2, Max5xxResponses: 20}
	case dto.ProfileWebDiscoveryLowRate:
		return dto.ScanOptions{RateLimit: 5, Concurrency: 2, Max5xxResponses: 10}
	case dto.ProfileSQLILowRisk:
		return dto.ScanOptions{RateLimit: 2, Concurrency: 1, Max5xxResponses: 5}
