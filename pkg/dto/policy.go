...
type ScanOptions struct {
	...
	HealthURL         string        `json:"health_url,omitempty" jsonschema:"optional absolute HTTP or HTTPS URL on the selected target origin, checked before and after the scan; relative paths and cross-origin redirects are rejected"`
